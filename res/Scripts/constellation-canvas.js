...
(function() {
  ...
  var constellations = [
    {
      name: "URSA MAJOR", nameCN: "北斗七星",
      desc: "大熊座 · 全年可见的导航星座",
      facts: ["勺口两颗星延长5倍即可找到北极星", "玉衡是北斗七星中最亮的一颗", "古人通过北斗斗柄指向判断季节"],
      stars: [
        {x:0.15,y:0.43,mag:2.4,label:"天璇"},
        {x:0.2,y:0.28,mag:1.8,label:"天枢"},
        {x:0.42,y:0.48,mag:2.4,label:"天玑"},
        {x:0.4,y:0.33,mag:2.4,label:"天权"},
    ...
    },
    {
      ...
      stars: [
        ...
        {x:0.6667,y:0.1806,mag:2.0,label:"参宿五"},
        {x:0.25,y:0.375,mag:2.1,label:"参旗六"},
        {x:0.7778,y:0.3611,mag:2.2,label:"参旗九"},
        {x:0.3889,y:0.4944,mag:2.2,label:"参宿一"},
        {x:0.5,y:0.4944,mag:2.2,label:"参宿二"},
        {x:0.6111,y:0.4861,mag:2.2,label:"参宿三"},
        {x:0.2917,y:0.8056,mag:2.1,label:"参宿六"},
    ...
    },
    {
      ...
      desc: "W形标志 · 北天拱极星座",
      facts: ["仙后座呈W形，与北斗七星隔北极星相对", "拱极星座全年可见，永不落下", "希腊神话中埃塞俄比亚王后"],
      stars: [
        {x:0.125,y:0.4063,mag:2.3,label:"策"},
        {x:0.3125,y:0.5938,mag:2.2,label:"王良一"},
        {x:0.5,y:0.3594,mag:2.5,label:"王良四"},
        {x:0.6875,y:0.6094,mag:2.7,label:"王良三"},
    ...
    },
    {
      ...
      stars: [
        {x:0.1563,y:0.1563,mag:2.9,label:"房宿四"},
        {x:0.2656,y:0.2031,mag:2.6,label:"房宿三"},
        {x:0.3438,y:0.1406,mag:2.9,label:"房宿二"},
        {x:0.3125,y:0.2969,mag:0.96,label:"心宿二"},
        {x:0.3594,y:0.4063,mag:2.8,label:"心宿三"},
        {x:0.375,y:0.5156,mag:2.7,label:"心宿一"},
        {x:0.4375,y:0.6094,mag:2.4,label:"尾宿一"},
        {x:0.5313,y:0.6719,mag:2.7,label:"尾宿二"},
        {x:0.6563,y:0.7031,mag:2.4,label:"尾宿三"},
        {x:0.7656,y:0.7656,mag:2.7,label:"尾宿四"},
        {x:0.8125,y:0.8594,mag:2.7,label:"尾宿五"},
        {x:0.7813,y:0.9375,mag:2.7,label:"尾宿六"},
        {x:0.8438,y:0.9063,mag:1.6,label:"尾宿八"}
      ],
      links: [[0,1],[1,2],[1,3],[3,4],[4,5],[5,6],[6,7],[7,8],[8,9],[9,10],[10,11],[11,12]]
    },
    {
      name: "CYGNUS", nameCN: "北十字",
      desc: "天鹅座 · 夏季大三角成员",
      facts: ["天津四是全天第19亮星，距离约2600光年", "十字形星群又称北十字", "是夏季大三角的顶点之一"],
      stars: [
        {x:0.5,y:0.125,mag:1.25,label:"天津四"},
        {x:0.5,y:0.3438,mag:2.5,label:"天津一"},
        {x:0.5,y:0.5938,mag:2.2,label:"天津九"},
        {x:0.5,y:0.8438,mag:3.0,label:"辇道增七"},
        {x:0.1875,y:0.4531,mag:2.5,label:"天津八"},
        {x:0.8438,y:0.4375,mag:2.5,label:"天津二"}
      ],
    ...
    },
    {
      ...
      stars: [
        ...
        {x:0.3571,y:0.3571,mag:2.9,label:"毕宿四"},
        {x:0.6071,y:0.375,mag:2.9,label:"毕宿六"},
        {x:0.6071,y:0.5357,mag:3.0,label:"毕宿八"},
        {x:0.75,y:0.5536,mag:3.4,label:"毕宿九"},
        {x:0.25,y:0.2857,mag:2.8,label:"天关"},
        {x:0.6964,y:0.2679,mag:2.8,label:"天街"}
      ],
    ...
    },
    {
      ...
      stars: [
        ...
        {x:0.35,y:0.42,mag:3.3,label:"渐台二"},
        {x:0.62,y:0.38,mag:3.5,label:"渐台三"},
        {x:0.32,y:0.72,mag:3.2,label:"渐台一"},
        {x:0.65,y:0.68,mag:3.4,label:"渐台四"}
      ],
    ...
    },
    {
      ...
      stars: [
        {x:0.5,y:0.1875,mag:2.8,label:"十字架一"},
        {x:0.5,y:0.7188,mag:0.76,label:"十字架二"},
        {x:0.2813,y:0.4531,mag:2.8,label:"十字架四"},
        {x:0.7344,y:0.4375,mag:1.25,label:"十字架三"},
        {x:0.5469,y:0.4688,mag:3.6,label:"十字架增一"}
      ],
      links: [[0,1],[2,3]]
    },
    {
      ...
      desc: "黄道第三宫 · 双胞胎并肩而立",
      facts: ["北河二、北河三代表双胞胎兄弟", "双子座流星雨每年12月出现", "北河三是全天第17亮星"],
      stars: [
        {x:0.22,y:0.18,mag:1.9,label:"北河二"},
        {x:0.22,y:0.48,mag:2.9,label:"北河二足"},
        {x:0.22,y:0.78,mag:3.1,label:"北河二脚"},
        {x:0.78,y:0.16,mag:1.14,label:"北河三"},
        {x:0.78,y:0.46,mag:2.9,label:"北河三足"},
        {x:0.78,y:0.76,mag:3.2,label:"北河三脚"},
        {x:0.5,y:0.32,mag:3.5,label:"井宿一"},
        {x:0.5,y:0.62,mag:3.6,label:"井宿三"}
      ],
    ...
    },
    {
      ...
      stars: [
        {x:0.18,y:0.32,mag:2.9,label:"轩辕七"},
        {x:0.28,y:0.22,mag:2.5,label:"轩辕六"},
        {x:0.42,y:0.26,mag:3.0,label:"轩辕五"},
        {x:0.52,y:0.36,mag:2.6,label:"轩辕四"},
        {x:0.48,y:0.52,mag:1.35,label:"轩辕十四"},
        {x:0.34,y:0.58,mag:2.5,label:"轩辕十三"},
        {x:0.58,y:0.68,mag:2.4,label:"五帝座一"},
        {x:0.72,y:0.62,mag:2.6,label:"五帝座二"}
      ],
    ...
    },
    {
      ...
      desc: "秋季星座 · 仙女座星系闻名",
      facts: ["仙女座星系M31是离银河系最近的大星系", "壁宿二是秋季四边形顶点", "希腊神话中被锁在岩石上的公主"],
      stars: [
        {x:0.12,y:0.32,mag:2.1,label:"奎宿九"},
        {x:0.28,y:0.4,mag:2.5,label:"奎宿八"},
        {x:0.48,y:0.46,mag:2.0,label:"壁宿二"},
        {x:0.68,y:0.4,mag:2.5,label:"奎宿五"},
        {x:0.85,y:0.3,mag:2.8,label:"奎宿四"},
        {x:0.48,y:0.62,mag:3.0,label:"天大将军一"},
        {x:0.62,y:0.72,mag:3.2,label:"天大将军二"}
      ],
    ...
    },
    {
      ...
      desc: "秋季四边形 · 飞马腾空",
      facts: ["飞马座大四边形是秋季夜空标志", "希腊神话中英雄珀尔修斯的坐骑", "飞马座51b是首颗发现的系外行星"],
      stars: [
        {x:0.28,y:0.28,mag:2.4,label:"室宿一"},
        {x:0.72,y:0.26,mag:2.5,label:"室宿二"},
        {x:0.74,y:0.66,mag:2.4,label:"壁宿一"},
        {x:0.26,y:0.68,mag:2.8,label:"壁宿二"},
        {x:0.1,y:0.52,mag:3.0,label:"危宿三"},
        {x:0.9,y:0.48,mag:3.2,label:"危宿一"}
      ],
    ...
    },
    {
      ...
      desc: "黄道第十宫 · 海山羊",
      facts: ["摩羯座象征坚韧与野心", "形象为海山羊，上羊下鱼", "摩羯座α星是双星系统"],
      stars: [
        {x:0.28,y:0.32,mag:3.0,label:"牛宿二"},
        {x:0.46,y:0.26,mag:2.9,label:"牛宿一"},
        {x:0.62,y:0.36,mag:3.1,label:"女宿一"},
        {x:0.58,y:0.52,mag:2.8,label:"女宿二"},
        {x:0.42,y:0.58,mag:3.0,label:"女宿三"},
        {x:0.28,y:0.52,mag:3.2,label:"虚宿一"},
        {x:0.18,y:0.42,mag:3.3,label:"牛宿增六"},
        {x:0.68,y:0.68,mag:2.9,label:"垒壁阵四"},
        {x:0.78,y:0.78,mag:3.1,label:"垒壁阵三"}
      ],
